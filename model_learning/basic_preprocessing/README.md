...
14개의 FSR 센서로 이루어진 RX-ES39A에서 데이터를 받아 저장하면 아래와 같은 형태이다.
...
위 논문에서 자르는 기준으로 앞과 뒤의 가속, 감속 구간을 제외한다.

<img src="../../src_img/ML_B_plot03.png" alt="plot01" width="500">

자르면 앞과 뒷 부분은 패턴 모습이 보이지 않아 제거한다.
...
scikit-learn을 이용해서 train : val : test => 8 : 1 : 로 split
